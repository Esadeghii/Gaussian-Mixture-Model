...
def pca_visualize_3D_centroids_and_std(centroids, std_devs, explained_variance_ratio, sphere_opacity=0.1):
...
def conduct_visualizations(path_to_dataset: str, path_to_model, sphere_opacity=0.2):
    ...
    pca_visualize_3D_centroids_and_std(centroids, std_devs, explained_variance_ratio, sphere_opacity)
