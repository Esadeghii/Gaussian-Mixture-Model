...
def genFigure(filePath):
    ...
    for clusters in range(len(correlation[0])):
        ax[4].plot(list(range(0,len(correlation[:,clusters])*10,10)),correlation[:,clusters], label=f"Train correlation {clusters}")
    ...
    for clusters in range(len(correlation[0])):
        ax[5].plot(list(range(0,len(correlation_valid[:,clusters])*10,10)),correlation_valid[:,clusters], label=f"Valid correlation {clusters}")
